        ...
        <div className="container mx-auto py-12">
            <div div className="flex justify-between items-center mb-4" >
                ...
                <div className="flex items-center justify-end gap-3" >
                    ...
                    {/* Next Button */}
                    <button onClick={navigation.nextEl} className="bg-[#F65D4E] p-2 rounded-full text-white flex items-center gap-1" >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div>
                ...
                >
                    <div className="">
                        {/* Previous Button */}
                        <SwiperButtonPrev className="bg-[#F65D4E] p-2 rounded-full text-white flex items-center gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12 15.75 4.5" />
                            </svg>
                        </SwiperButtonPrev>
                        ...
                        {/* Next Button */}
                        <SwiperButtonNext className="bg-[#F65D4E] p-2 rounded-full text-white flex items-center gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            </svg>
                        </SwiperButtonNext>
                    ...
                    <div>
                        {exchangeBooks.map(item => <SwiperSlide key={item.id}><ExchangeCard item={item} /></SwiperSlide>)}
                    </div>
                </Swiper>
            </div>
        </div>
