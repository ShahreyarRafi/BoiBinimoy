...
import { GiSpeedometer, GiClick } from "react-icons/gi";
              ...
              <div className="flex py-10 ">
                <div className="">
                  <div className="flex items-center mb-1">
                    ...
                    <div className="w-32 h-1 bg-[#016916]" />
                  </div>
                  {/* <div className="pt-1 pr-10 max-w-44">
                    <p className="text-xs text-center">Order</p>
                  </div> */}
                </div>
                <div className="">
                  <div className="flex items-center mb-1">
                ...
                <div className="">
                  ...
                  {/* <div className="pt-1 pr-10 max-w-44">
                    <p className="text-xs">Delivarying</p>
                  </div> */}
                </div>
                <div className="">
                  <div className="flex items-center mb-1">
                    ...
                    {/* <div className="w-full h-1 bg-[#016916]" /> */}
                  </div>
                  {/* <div className="pt-1 pr-10 max-w-44">
                    <p className="text-xs">Order</p>
                  </div> */}
          ...
          <div className="border-2 p-5 rounded-lg bg-50-50">
            ...
            <div className="overflow-x-scroll">
              <table className="w-full mt-2">
                <tr>
                  <th className="border border-[#016961] p-2">#</th>
                  <th className="border border-[#016961] p-2">Order Code</th>
                  <th className="border border-[#016961] p-2">Product Nme</th>
                  <th className="border border-[#016961] p-2">Qty</th>
                  <th className="border border-[#016961] p-2">Price</th>
                  <th className="border border-[#016961] p-2">
                    Delivery Status
                  </th>
                  <th className="border border-[#016961] p-2">Order Status</th>
                  <th className="border border-[#016961] p-2">Payout</th>
                </tr>
                <tr>
                  <td className="border border-[#016961] p-2">1</td>
                  <td className="border border-[#016961] p-2">
                    02i09j01945u1jlaslj
                  </td>
                  <td className="border border-[#016961] p-2">
                    A nice book name
                  </td>
                  <td className="border border-[#016961] p-2">3</td>
                  <td className="border border-[#016961] p-2">320</td>
                  <td className="border border-[#016961] p-2">
                    <p className="p-1 w-fit bg-gray-400 text-white text-sm rounded-md">
                      Painding
                    </p>
                  </td>
                  <td className="border border-[#016961] p-2">
                    <p className="p-1 w-fit bg-blue-400 text-white text-sm rounded-md">
                      Done
                    </p>
                  </td>
                  <td className="border border-[#016961] p-2">
                    <p className="p-1 w-fit bg-green-400 text-white text-sm rounded-md">
                      Active
                    </p>
                  </td>
                </tr>
