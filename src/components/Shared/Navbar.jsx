        ...
        <div className="navbar">
          <div className="navbar-start md:mr-10">
            ...
            <Link href="/">
              <div className="flex items-center gap-2">
                <Image
                  src="https://i.ibb.co/PxBs9dH/Boi-Binimoy-Transparent-Big.png"
                  alt="card"
                  priority
                  width={500}
                  height={500}
          ...
          <div className="navbar-center hidden md:flex">
            <input
              ...
              className="bg-base-300 text-black rounded-l-full rounded-r-full pl-4 py-2 w-[200px] md:w-[250px] lg:w-[400px]"
            />
            <button className="bg-[#f65d4e] rounded-full relative right-[55px]">
              <IoSearch className="text-white m-3 w-8"></IoSearch>
            </button>
          </div>
          ...
          <div className="navbar-end flex gap-3 md:gap-6">
            ...
            <button>
              <BsBasket3 className="text-lg"></BsBasket3>
            </button>
            <button onClick={handleLogOut}>Lgout</button>
            <Link href="/login" className="bg-[#f65d4e] text-white btn btn-sm">
              Login
            </Link>
          </div>
        </div>
        ...
        <div className="navbar bg-base-100">
          <div className="navbar-start">
            ...
            <div className="flex items-center gap-2 bg-[#f65d4e] text-white p-2 w-[200px] rounded-l-full rounded-r-full">
              <p>
                <CgMenuGridO className="text-2xl"></CgMenuGridO>
              </p>
            ...
            <div className="flex ml-3 md:hidden">
              <input
                type="text"
                placeholder="Search products..."
                className="bg-base-300 text-black rounded-l-full rounded-r-full pl-4 py-2 w-[200px]"
              />
              <button className="bg-[#f65d4e] rounded-full relative right-10">
                <IoSearch className="text-white m-3 w-8"></IoSearch>
              </button>
            </div>
          </div>
          ...
          <div className="navbar-end hidden md:flex">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-[#f65d4e] text-md font-bold">
                  +84-1800-4635
                </p>
