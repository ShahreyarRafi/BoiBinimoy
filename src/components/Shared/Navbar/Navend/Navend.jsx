          ...
          <div className="dropdown dropdown-end ">
            <label tabIndex={0} className="cursor-pointer">
              <div className="">
                <div className="w-10 rounded-full">
                  ...
                  <Image src={user.photoURL} alt="user" onClick={() => setActive(!active)}
...

            {
              active && (
                ...
                >
                  <Link href="dashboard"><button className="px-4 py-2 hover:bg-base-300 rounded-lg"> Dashboard </button></Link>
                  <div
                    onClick={logOut}
