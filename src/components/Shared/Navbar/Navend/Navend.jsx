            ...
            <div>
              <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52">
                  <li>
                    <Link href="/dashboard/profile" className="px-4 py-2 text-xl hover:bg-base-300 rounded-lg text-black">
                      Profile
                    </Link>
                  </li>
                  <li>
                    <Link href="/dashboard" className="px-4 py-2 text-xl hover:bg-base-300 rounded-lg text-black">
                      Dashboard
                    </Link>
                  </li>
                  <li>
                    <button
                      onClick={logOut}
                      className="cursor-pointer text-xl text-red-500 px-4 py-2 hover:bg-base-300 rounded-lg"
                    >
                      Logout
                    </button>
                  </li>
