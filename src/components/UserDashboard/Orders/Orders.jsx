    ...
    <div className="container duration-300">
      <div className="w-full rounded-2xl overflow-hidden lg:shadow-lg my-5 duration-300">
        <div className="bg-[#016961] duration-300 text-white ">
          <div className="grid grid-cols-10 items-center justify-between font-semibold border border-gray-100 px-10 py-5">
            ...
            <h5 className="text-center text-xs md:text-base col-span-2">Email</h5>
