          ...
          <div class="flex flex-row">
            ...
            <div class="flex-auto border rounded  border-gray-300">
              <div class="flex md:flex-row flex-col items-center">
                ...
                <div class="md:w-96 w-full p-5"></div>
              </div>
            </div>
          </div>
              ...
              <div class="flex md:flex-row flex-col items-center">
                <div class="flex-auto">
                  ...
                  <div class="px-3 pb-6">
                    ...
                    It&apos;s not just a platform - it&apos;s a space where
                    books find new homes, stories unfold, and connections
                    blossom. Every exchange, every review, every book read on
                    our platform whispers our story, the story of how a dream of
                    sharing sparked a revolution in the world of books.
                  </div>
                </div>
                <div class="md:w-96 w-full p-5"></div>
              </div>
